...
if($msgtype == "event"){
	if($p->Event == "subscribe"){
		$t1 = "科倍软件公众平台-会员中心";
		$d1 = "科倍软件公众平台-会员中心";
		$p1 = "http://chn.ittun.com/img/1.png";
		$u1 = "#";
		$t2 = "亲您有0张优惠券";
		$d2 = "亲您有0张优惠券";
		$p2 = "http://chn.ittun.com/img/2.png";
		$u2 = "#";
		$t3 = "下次保险日期为：2016-06-26";
		$d3 = "下次保险日期为：2016-06-26";
		$p3 = "http://chn.ittun.com/img/3.png";
		$u3 = "#";
		$t4 = "下次保养日期为：2015-11-26";
		$d4 = "下次保养日期为：2015-11-26";
		$p4 = "http://chn.ittun.com/img/4.png";
		$u4 = "#";
		$t5 = "下次年审日期为：2017-06-23";
		$d5 = "下次年审日期为：2017-06-23";
		$p5 = "http://chn.ittun.com/img/5.png";
		$u5 = "#";
		$backstr = sprintf($str_article,$userid,$touser,time(),"news",5,$t1,$d1,$p1,$u1,$t2,$d2,$p2,$u2,$t3,$d3,$p3,$u3,$t4,$d4,$p4,$u4,$t5,$d5,$p5,$u5);
		echo $backstr;
	}
}	
